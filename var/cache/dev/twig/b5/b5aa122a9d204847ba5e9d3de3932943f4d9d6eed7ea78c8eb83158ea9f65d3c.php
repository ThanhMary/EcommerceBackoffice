...
class __TwigTemplate_a9ec71f0aa4db5ef2a5fa1f5fb2bd97992df1b044226d06d160018ea20364b2e extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t<td>";
            // line 30
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["product"], "category", [], "any", false, false, false, 30), "label", [], "any", false, false, false, 30), "html", null, true);
            echo "</td>

\t\t\t\t\t<td>
\t\t\t\t\t\t<a href=\"";
            // line 33
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("product_show", ["id" => twig_get_attribute($this->env, $this->source, $context["product"], "id", [], "any", false, false, false, 33)]), "html", null, true);
            echo "\">show</a>
\t\t\t\t\t\t<a href=\"";
            // line 34
...
";
    ...
    {
        return array (  168 => 45,  163 => 42,  154 => 38,  145 => 34,  141 => 33,  135 => 30,  131 => 29,  127 => 28,  123 => 27,  119 => 26,  115 => 25,  112 => 24,  107 => 23,  89 => 7,  79 => 6,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "product/index.html.twig", "C:\\Users\\thanh\\Desktop\\YNOV\\ARCHITECTURELOGICIEL\\PROJET\\ecommerce\\templates\\product\\index.html.twig");
    }
}
