...
class __TwigTemplate_281fb8fa53a3452ed6d66516c480333036ea4fe396b3da8279b09f6caf171670 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["category"]) || array_key_exists("category", $context) ? $context["category"] : (function () { throw new RuntimeError('Variable "category" does not exist.', 16, $this->source); })()), "label", [], "any", false, false, false, 16), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "category/show.html.twig", "C:\\Users\\thanh\\Desktop\\YNOV\\ARCHITECTURELOGICIEL\\PROJET\\ecommerce\\templates\\category\\show.html.twig");
    }
}
